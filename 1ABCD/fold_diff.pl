...
sub calculate_fold_diff{
    ...
    #largest_fold_diff set to 1 so it can be increased, lowest_fold_diff set to 500000 so it can be decreased.
    my($skip_ID_row,$largest_fold_diff,$lowest_fold_diff,$largest_count,$lowest_count) = (1,0,500000,0,0);
